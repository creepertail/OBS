  ...
  <div class="login">
    ...
    <form>
      <fieldset class="fieldset">
        ...
        <input id="username" type="username" class="input w-full" placeholder="Username">
